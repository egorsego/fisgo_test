...
public class KFReturnComingTest extends BaseTestClass {
    ...
    public void beforeClass() {
        ...
        steps.payment().payOnePositionCash(1000);
        goToReturn();
    }
    ...
    @Test
    public void returnConsideration() {
        clearData();
        previousFdNum = manager.getLastFdNum();
        goToReturnComing();
    ...
    //__________________________________________________ STEPS _________________________________________________________
